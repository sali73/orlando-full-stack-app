            ...
            <Layout>
                <div className='login'>
                    ...
                    <form className='login-form' action="/sessions/" method="POST">
                        ...
                        <input className="form-control form-control-md"  type="text" name="username" />
                        <label for="exampleFormControlInput1"><h4>Password:</h4></label>
                        <input className="form-control form-control-md"  type="password" name="password" /><br />
                        <input  type="submit" value="Login User" className="btn btn-secondary btn-lg btn-block" />
                    </form>
                </div>
            </Layout>
        );
